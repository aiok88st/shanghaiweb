<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:56:"F:\wamp\www\shanghaiweb/app/admin\view\category\add.html";i:1516947319;s:55:"F:\wamp\www\shanghaiweb/app/admin\view\common\head.html";i:1516708701;s:55:"F:\wamp\www\shanghaiweb/app/admin\view\common\foot.html";i:1512625649;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="admin-main fadeInUp animated">
    ...
    <form class="layui-form layui-form-pane">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" name="url" value="" placeholder="请输入栏目链接地址，如：index/index" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="radio" name="ismenu" lay-filter="is_open" checked value="1" title="显示">
                <input type="radio" name="ismenu" lay-filter="is_open" value="0" title="不显示">
                <input type="radio" name="ismenu" lay-filter="is_open" value="2" title="后台显示">
            </div>
        </div>
