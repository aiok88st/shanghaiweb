<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:55:"F:\wamp\www\shanghaiweb/app/mobile\view\news\index.html";i:1516934405;s:58:"F:\wamp\www\shanghaiweb/app/mobile\view\common\header.html";i:1516931996;s:58:"F:\wamp\www\shanghaiweb/app/mobile\view\common\footer.html";i:1516930425;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<link rel="stylesheet" href="__MOBILE__/css/news.css" />
    ...
    <div class="navBox">
		...
		<section id="mainContent">
			<div class="box news">
				...
				<div class="newsBox">
					<!--事件小于等于四件时。设置newsBoxIn的overflow:hidden-->
					<div class="newsBoxIn" <?php if($count <= 4): ?>style="overflow:hidden;"<?php endif; ?> >
						<ul>
                            <?php if(is_array($team) || $team instanceof \think\Collection || $team instanceof \think\Paginator): $k = 0; $__LIST__ = $team;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                                <li>
                                    <a href="<?php echo url('News/detail'); ?>?id=<?php echo $vo['id']; ?>">
                                        <p class="floatl"><?php echo date("Ym",$vo['createtime']); ?>&nbsp;&nbsp;</p>
                                        <p class="floatl"><?php echo $vo['title']; ?></p>
