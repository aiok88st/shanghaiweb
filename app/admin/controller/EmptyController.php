...
class EmptyController extends Common{
    ...
    public function index(){
        ...
        if(request()->isPost()){
            ...
            if($modelname == 'product'){
                return $this->fetch ('content/productList');
            }elseif($modelname == 'enproduct'){
                return $this->fetch ('content/enproductList');
            }elseif($modelname == 'picture'){
                return $this->fetch ('content/aboutList');
            }elseif($modelname == 'enpicture'){
                return $this->fetch ('content/enaboutList');
            }elseif($modelname == 'page'){
    ...
    public function edit(){
        ...
        if($info['images']){
            $info['img'] = explode(';',rtrim($info['images'],';'));
        }
        ...
        if($catid == 60){
            $catids = getTree2('category',0,1,60);
            $this->assign ( 'catids', $catids );
            return $this->fetch('content/edit_project');
        }else{
            return $this->fetch('content/edit');
        }
    }
